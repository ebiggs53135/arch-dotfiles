...
myConfig = "/home/bigge/.config/qtile/config.py"    # The Qtile config file location
...
def init_widgets_list():
    widgets_list = [
              ...
              #         fontsize = 12
              #         ),
              #     #########DO NOT USE WEATHER WIDGET AS-IS! IT BREAKS THE
              #     CONFIG!!
              #widget.YahooWeather(
              #         woeid = 12778444,
              #         fmt = '{current_observation_condition_symbol,current_observation_condition_temperature}',
              #         metric = False,
              #         #woeid = 12778444,
              #         foreground = colors[2],
              #         background = colors[4],
